    ...
    <div class="row mt-5">
        <div class="col-md-12">
            ...
            <div class="card card-info">
                <form id="validate_form" action="{{ route('category.update',$category->id) }}" method="post"
                        ...
                        <div class="form-group">
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                    name="name" placeholder="Name" required data-parsley-trigger="keyup" minlength="3"
                                    id="editor" value="{{ $category->name }}">
                                @if($errors->has('name'))
